...
export default function Prescr() {
  ...
  useEffect(()=>{
    axios.get(`http://localhost:8000/prescription/`+id)
    .then((getDataa)=>{
  ...
  useEffect(()=>{
    axios.get(`http://localhost:8000/profiles/`+petid)
    .then((getData)=>{
...
<div className='header-main'>
        <div className='heder-container'>
            ...
            <div className="medicin-container">
              ...
              <textarea id="medicine" name="medicine"  value={medicine} rows="4" cols="30" onChange={(event)=>{
            ...
            <div className="lab-report-container">
              ...
              <textarea id="labreport" name="labreport"  value={labreport} rows="4" cols="30" onChange={(event)=>{
            ...
            <div className="advice-given-container">
              ...
              <textarea id="advicegiven" name="advicegiven"  value={advicegiven} rows="4" cols="30" onChange={(event)=>{
