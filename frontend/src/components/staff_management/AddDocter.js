       ...
       <div className="title_add">
            ...
            <div className="Dochalf">
              ...
              <div className="Dochalf">
                ...
                <input className="doctor" type="text" id = "docID" name="docID" value={this.state.docID} onChange={this.handleInputChange} required />
            ...
            <div className="Dochalf">
                <div className="Docitem">
                  ...
                  <input className="doctor" type="text" id = "name"  name="age"  value={this.state.age} onChange={this.handleInputChange} required/>
                </div><br/>
            ...
            <div className="Docitem">
              <label for="name">Experience</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input className="doctor" type="text" id = "name"  name="experience"  value={this.state.experience} onChange={this.handleInputChange} required/>
            </div><br/>
            <div className="Docitem">
              <label for="name">Salary</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input className="doctor" type="text" id = "name"  name="salary"  value={this.state.salary} onChange={this.handleInputChange} required/>
            </div><br/>
