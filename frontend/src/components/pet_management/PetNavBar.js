...
export default function NavBar() {
    ...
    return <div className="nav_main_container">
            <div className="nav_header">
                <p className="nav_heading_text">APPOINTMENT MANAGER</p>
            </div>

            <div className="nav_body">
                <NavLink to="/viewPets" className="link_styles">
                    <div className="nav_link_wrapper">
                        <DashboardIcon fontSize="small" style={{ marginLeft: "45px" }} />
                        <p className="nav_link clearfix">PET PROFILES</p>
                    </div>
                </NavLink>
            </div>

            <div className="nav_body ">
                <NavLink to="/Newform" className="link_styles">
                    <div className="nav_link_wrapper">
                        <AutorenewIcon fontSize="small" style={{ marginLeft: "45px" }} />
                        <p className="nav_link clearfix">ADD NEW PET</p>
                    </div>
                </NavLink>
            </div>

            <div className="nav_body ">
                <NavLink to="/ViewInquiries" className="link_styles">
                    <div className="nav_link_wrapper">
                        <AutorenewIcon fontSize="small" style={{ marginLeft: "45px" }} />
                        <p className="nav_link clearfix">INQUIRIES </p>
                    </div>
                </NavLink>
            </div>
