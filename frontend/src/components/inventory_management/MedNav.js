  ...
  return (
    <div className="nav_main_container">
      <div className="nav_header">
        <p className="nav_heading_text">INVENTORY MANAGER</p>
      </div>
      ...
      <div className="nav_body ">
        <NavLink to="/AddMed" className="link_styles">
          <div className="nav_link_wrapper">
            <AutorenewIcon fontSize="small" style={{ marginLeft: "45px" }} />
            <p className="nav_link clearfix">ADD MEDICINES</p>
          </div>
        </NavLink>
      </div>

      <div className="nav_body ">
        <NavLink to="/viewMed" className="link_styles">
          <div className="nav_link_wrapper">
            <DepartureBoardIcon
              fontSize="small"
              style={{ marginLeft: "45px" }}
            />
            <p className="nav_link clearfix">MEDICINES</p>
          </div>
        </NavLink>
      </div>

      <div className="nav_body ">
        <NavLink to="/BuyerReq" className="link_styles">
          <div className="nav_link_wrapper">
            <DepartureBoardIcon
              fontSize="small"
              style={{ marginLeft: "45px" }}
            />
            <p className="nav_link clearfix">BUYER REQUESTS</p>
          </div>
        </NavLink>
      </div>

      <div className="nav_body ">
        <NavLink to="/MedReport" className="link_styles">
          <div className="nav_link_wrapper">
            <ReportIcon fontSize="small" style={{ marginLeft: "45px" }} />
            <p className="nav_link clearfix">MEDICINES REPORTS</p>
          </div>
        </NavLink>
      </div>
    </div>
